...
public class Test01 {
    public static void main(String[] args) throws Exception{
        ...
        Class c1 =Class.forName("基础.反射.Person");
        System.out.println(c1);
        Class c2 =Class.forName("基础.反射.Person");
        /*
            一个类被加载后只有一个Class对象
    ...
    public void test() throws ClassNotFoundException {
        ...
        //方法三：调用Class的静态方法
        Class clazz3 = Class.forName("基础.反射.Person");
        //方法四：使用类加载器
        ClassLoader classLoader = Test01.class.getClassLoader();
        Class clazz4 = classLoader.loadClass("基础.反射.Person");
    ...
    public void Test04() throws Exception {
        Class clazz = Class.forName("基础.反射.Person1");
        //利用newInstance创建对象
